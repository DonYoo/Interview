...
public class RemoveEntries {
	...
	public static void main(String[] args) {
        ...
        if(isoCode != null){
        	System.out.println("Removed (" + countryName + " => " + isoCode +")" );
        	System.out.println("CountryISOCodeMapping : " + countryISOCodeMapping);
        }
        else{
        	System.out.println(countryName + 
        			" does not exist, or it is mapped to a null value");
        }
        
        
        // Remove the mapping for the given key only if it is mapped to the given value
        countryName = "India";
        boolean isRemoved = countryISOCodeMapping.remove(countryName, "WRONG");
        ...
        System.out.println("Removed firstEntry : " + lastEntry + ", New TreeMap : " + countryISOCodeMapping);
	}
